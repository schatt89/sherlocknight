...
ggplot() + 
  ...
  scale_color_discrete(name = "Упоминание", breaks = c("h", "sh", "me", "j", "mo", "mol"), labels = c("Хадсон", "Шерлок", "Мэри", "Джон", "Мориарти", "Молли"))
...
ggplot() + 
  ...
  scale_color_discrete(name = "Упоминание", breaks = c("h", "sh", "me", "j", "mo", "mol", "e"), labels = c("Хадсон", "Шерлок", "Мэри", "Джон", "Мориарти", "Молли", "Эвер")) +
  scale_fill_discrete(name = "Упоминание", breaks = c("h", "sh", "me", "j", "mo", "mol", "e"), labels = c("Хадсон", "Шерлок", "Мэри", "Джон", "Мориарти", "Молли", "Эвер"))
```
